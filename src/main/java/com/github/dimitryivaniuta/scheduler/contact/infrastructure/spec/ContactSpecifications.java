package com.github.dimitryivaniuta.scheduler.contact.infrastructure.spec;
...
public final class ContactSpecifications {
    ...
    public static Specification<Contact> fromFilter(ContactFilterRequest f) {
        return (root, query, cb) -> {
            ...
            // email (citext in DB, String in JPA)
            if (hasText(f.email())) {
            ...
            // free-text (backed by trgm indexes on email/name/company/tags)
